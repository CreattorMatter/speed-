...
interface AnalyticsData {
  salesData: Array<{ name: string; value: number; color: string; logo: string; }>;
  monthlyData: Array<{ name: string; Easy: number; Jumbo: number; Disco: number; Vea: number; }>;
  regionData: Array<{ name: string; value: number; byCompany: Record<string, number>; }>;
  topProducts: Record<string, TopProduct[]>;
  stats: {
    totalSales: string;
    regions: number;
    products: string;
    trends: { sales: string; regions: string; products: string; };
  };
  promotionData: Array<{ name: string; conversion: number; sales: number; company?: string; animationDelay?: number; }>;
  storeSLAData: Array<{ store: string; sla: number; printTime: number; company?: string; }>;
}
