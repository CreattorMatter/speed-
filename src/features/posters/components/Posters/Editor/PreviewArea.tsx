...
interface PreviewAreaProps {
  ...
  selectedBuilderTemplate?: TemplateV3 | null;
  builderComponents?: DraggableComponentV3[];
}
...
export const PreviewArea: React.FC<PreviewAreaProps> = ({
  ...
  // Si hay una plantilla del builder seleccionada, la renderizamos y salimos.
  if (selectedBuilderTemplate) {
    return (
